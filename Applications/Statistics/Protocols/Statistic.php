...
//        return $data['module_name_len'] + $data['interface_name_len'] + $data['msg_len'] + self::PACKAGE_FIXED_LENGTH;
        ...
        $data = unpack("Cmodule_name_len/Cinterface_name_len/fcost_time/Csuccess/Ncode/nmsg_len/nextra_len/Ntime", $recv_buffer);
        return $data['module_name_len'] + $data['interface_name_len'] + $data['msg_len'] + $data['extra_len'] + self::PACKAGE_FIXED_LENGTH;
    }
...
//        $data = unpack("Cmodule_name_len/Cinterface_name_len/fcost_time/Csuccess/Ncode/nmsg_len/Ntime", $recv_buffer);
        ...
        $msg = substr($recv_buffer, self::PACKAGE_FIXED_LENGTH + $data['module_name_len'] + $data['interface_name_len'], $data['msg_len']);
        $extra = substr($recv_buffer, self::PACKAGE_FIXED_LENGTH + $data['module_name_len'] + $data['interface_name_len'] + $data['msg_len']);
