...
function phpstathome($module, $interface, $date, $start_time, $offset)
{
    ...
    if(!empty($groups)){
        foreach ($groups as $group){
            $group_str .=  "<a href='/?fn=phpstat&group=".$group."'>&raquo;".$group."</a><br>";
        }
    }else{
        $group_str = '暂无数据!';
    }
...
EOT;
    ...
    include ST_ROOT . '/Views/phpstathome.tpl.php';
