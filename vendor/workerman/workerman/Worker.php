...
class Worker
{
    ...
    protected static function init()
    {
        ...
        // Process title.
//        self::setProcessTitle('Cheng95: master process  start_file=' . self::$_startFile);
        self::setProcessTitle('Cheng95: master process');
    ...
    protected static function forkOneWorker($worker)
    {
        ...
        elseif (0 === $pid) {
            ...
            Timer::delAll();
            self::setProcessTitle('Cheng95: worker process  ' . $worker->name . ' ' . $worker->getSocketName());
